...
import { ReactComponent as BillionairIcon } from './../assets/img/social/sprite-9c60ffc5a924d1ba.svg';
          ...
          <main class="relative z-10 overflow-x-hidden bg-dark">
            <div class="Background_container__RCLV5">
              <div class="Background_content___GAg0">
                <section class="relative flex flex-col overflow-hidden pt-[150px] sm:pt-25 sm:pb-8 md:pt-[150px] md:pb-10 lg:pt-[150px] lg:pb-14 xl:pt-[150px] xl:pb-17">
                  <div class="text-white mx-[40px] pt-[0px] sm:mt-[50px] sm:pt-[50px] lg:mx-[164px] gap-[16px] lg:mx-[164px]"> 
                  <section class="gs container " id="invest">
                    <div class="gs-container   px-[20px]  pb-3 
                     sm:gap-x-12px sm:px-[60px] sm:py-4 md:gap-x-3 md:px-12 md:py-8 lg:px-8 lg:py-7 xl:gap-[99px] xl:py-4 xl:px-18 ">
